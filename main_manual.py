...
setting = {
    "amp1": [0.5, 0.1],  # Amplitude for drive output
    "amp2": [0.4],  # Amplitude for modulation output
    "frerange": [[60000, 63000], [60000, 80000]],  # Frequency range for sweeper
    ...
    "setling_time": 0,  # Settling time for sweeper
}
...
def main(params={}):
    ...
    generate_setting
    path, timestamp = create_new_folder(suffix=f"_{amp1}_{amp2}")
...
if __name__ == "__main__":
    setting_one = {}
    setting_one["bandwidth"] = setting["bandwidth"]
    setting_one["inaccuracy"] = setting["inaccuracy"]
    setting_one["maxbandwidth"] = setting["maxbandwidth"]
    setting_one["samplecount"] = setting["samplecount"]
